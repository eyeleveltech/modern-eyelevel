  ...
  return (
    <section className="py-12 md:py-16 px-4 bg-forest-deep relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <h2 className="font-dela text-4xl md:text-5xl lg:text-6xl leading-[1.05] mb-6">
            <span className="text-white">Proof That We</span>
            <br />
            <span className="relative inline-block">
              <span className="text-primary">Don't Just Talk</span>
              <motion.svg
        ...
        >
                    ...
                    <div className="relative aspect-video overflow-hidden">
                      ...
                      >
                        <motion.button
                          ...
                          className="w-16 h-16 md:w-20 md:h-20 rounded-full flex items-center justify-center cursor-pointer backdrop-blur-sm shadow-neo-md bg-primary"
                          whileHover={{ scale: 1.15 }}
                          whileTap={{ scale: 0.95 }}
                        >
                          <Play className="w-6 h-6 md:w-8 md:h-8 text-foreground fill-current ml-1" />
                        </motion.button>
                      </motion.div>

                      {/* Result Badge */}
                      <motion.div
                        className="absolute top-4 right-4 text-foreground px-3 py-1.5 md:px-4 md:py-2 rounded-full font-dela text-xs md:text-sm bg-primary"
          ...
          <div className="flex items-center justify-center gap-4 mt-10">
            <CarouselPrevious className="static translate-y-0 bg-transparent border-2 border-primary/30 text-primary hover:bg-primary hover:text-forest-950 hover:border-primary w-12 h-12 rounded-full transition-all duration-300" />
            <CarouselNext className="static translate-y-0 bg-transparent border-2 border-primary/30 text-primary hover:bg-primary hover:text-forest-950 hover:border-primary w-12 h-12 rounded-full transition-all duration-300" />
          </div>
        </Carousel>
      </div>
      ...
      <Dialog open={!!selectedVideo} onOpenChange={() => setSelectedVideo(null)}>
        <DialogContent className="max-w-4xl w-[95vw] p-0 bg-forest-deep border-primary/20 overflow-hidden">
          <VisuallyHidden>
          ...
          <AnimatePresence>
            {selectedVideo && (
              ...
              >
                ...
                {/* Video Info Bar */}
                <div className="p-4 md:p-6 bg-background flex items-center justify-between">
                  ...
                  <div className="bg-primary text-forest-950 px-4 py-2 rounded-full font-dela text-sm">
